$(document).ready(function() {
	...
	$('#locateButton').click(function(event) {
		event.preventDefault();
		// alertError('Uhhh, this doesn\'t work yet xD');
		getLocation();
		// processForm();
	});
...
function getLocation() {
  ...
  function processLocation(position) {
	// alertError("Latitude: " + position.coords.latitude + 
	...
	function displayForecast(api_response) {
